            ...
            <div class="jinner-content">
                ...
                <form method="post" name="emailpro" action="sendmail.php" onsubmit="return ValidateForm();">
                    <table cellspacing="8" width="100%">
                        ...
                        <tr>
                            <td colspan="2">
                                Die Arbeit des Vereins will ich unterstützen als</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <p>
                                    Als zahlendes Mitglied bei Anahata e.V. haben Sie zwei Möglichkeiten die Arbeit
                                    des Vereins zu unterstützen. Zum einen können Sie einen monatlichen Betrag regelmäßig
                                    überweisen oder eine Einzelspende tätigen. Eine Spendenbescheinigung erhalten Sie
