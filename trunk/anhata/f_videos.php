...
<script type="text/javascript">
                var e = document.getElementById("allAboutUs");
...
<div class="jcontent-area">
  ...
  <div class="jleft-column">
                <div class="jtext-area" style="height: 190px; padding: 0px 16px 0px 32px; "">
                    <h2>
                        Videos</h2>
                    <div style="vertical-align: text-top; float: left;">
                        <p style="text-align: justify; padding: 5px;">
                            <object width="425" height="344">
                                <param name="movie" value="http://www.youtube.com/v/z8hyqAiMjPg&hl=en_US&fs=1&"></param>
                                <param name="allowFullScreen" value="true"></param>
                                <param name="allowscriptaccess" value="always"></param>
                                <embed src="http://www.youtube.com/v/z8hyqAiMjPg&hl=en_US&fs=1&" type="application/x-shockwave-flash"
